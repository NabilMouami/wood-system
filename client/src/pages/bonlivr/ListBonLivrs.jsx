...
function ListBonLivrs() {
  ...
  const details = (dts) => {
    ...
    navigate("/app/list-bonlivraison/" + dts.id);
  };
  const filterDate = () => {
    if (date === "") {
