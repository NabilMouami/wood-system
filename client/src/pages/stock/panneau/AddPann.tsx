...
import { PostPanneau } from "../../../models/bois/Panneau";

const AddPann: React.FC = () => {
  const [post, setUser] = useState<PostPanneau>({
    type: "",
    marque: "",
    fornisseur: "",
    piece_total: 0,
  ...
  const submitHandler = (e: React.FormEvent) => {
    e.preventDefault();
    custom_axios
      .post("stock/panneau", JSON.stringify(post), {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
        },
      })
      .then(() => {
        toast.success("Ajoute Success De Panneau!!", {
          position: "top-right",
        });
      });
  };
