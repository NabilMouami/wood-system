...
function UpdBoisDur() {
  ...
  const [prix_achat, setPrixAchat] = useState(Col.prix_achat);
  const [prix_vente, setPrixVente] = useState(Col.prix_vente);
  ...
  const submitHandler = (e: React.FormEvent) => {
    e.preventDefault();
    custom_axios
      .put(`/stock/boisdur/${Col.id}`, JSON.stringify(post), {
        headers: {
            ...
            <div className="bg-white text-black rounded shadow-lg p-4 px-4 md:p-8 mb-6">
              <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                <div className="text-gray-600">
                  ...
                  <p>De Bois Dur {Col.marque}.</p>
                  <img
                    className="mt-4"
                    src="/images/bois-dur.jpg"
                    alt="bois-blanc"
                    height="300"
                    width="250"
                  />
