...
import { PostBoisBlanc } from "../../../models/bois/BoisBlanc";
import custom_axios from "../../../axios/AxiosSetup";

const AddBoisBlanc: React.FC = () => {
  const [post, setUser] = useState<PostBoisBlanc>({
    marque: "",
    fornisseur: "",
    n_fardou: "",
    pieces: 0,
  ...
  const submitHandler = (e: React.FormEvent) => {
    ...
    custom_axios
      .post("/stock/boisblanc", JSON.stringify(post), {
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
        },
      })
      .then(() => {
        toast.success("Ajoute Success De Bois Blanc!!", {
          position: "top-right",
        });
      });
  };
