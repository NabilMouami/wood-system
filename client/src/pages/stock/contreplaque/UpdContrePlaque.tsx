...
function UpdContrePlaque() {
  ...
  const [face, setFace] = useState(Col.face);
              ...
              <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                  <div className="text-gray-600">
                    ...
                    <p>De Contre Plaque {Col.type}.</p>
                    <img
                      className="mt-4"
                      src="/images/contre-plaque.jpg"
                      alt="bois-blanc"
                      height="300"
                      width="250"
                    />
...
export default UpdContrePlaque;
